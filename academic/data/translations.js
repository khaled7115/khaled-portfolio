...
latestCertVerify: 'التحقق من الشهادة',
    ...
    portalSportsDesc: 'هذا القسم فارغ حاليًا — يمكن إضافة محتوى هنا لاحقًا.',
    portalEnter: 'ادخل',
...
latestCertVerify: 'Проверить сертификат',
    ...
    portalAcademicDesc: 'Сертификаты, академический путь, проекты и долгосрочная дорога к карьере в технологиях.',
